...
const API_SPECS = [
  ...
  { fn: 'apiShopCreateRequest',    scope: 'shop',
    args: (t) => [t, { branchCode: 'VIE', team: '関東', groomLastName: '侵入', groomName: 'テスト', brideLastName: '侵入', brideName: 'テスト2', hope1: '2026-09-01', plan: '', challengeNo: 'AUDITCHG001' }], writes: true },

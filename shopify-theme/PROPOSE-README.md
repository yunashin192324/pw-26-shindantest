...
旅行先エントリーの `hotels` / `chapels`（単一行テキストのリスト）に入れた会場が、TOP の「ホテルでも、チャペルでも。」、
旅行先ページの Venue 欄、予約フォームの会場選択（おまかせ／各会場）に出ます。会場の使用料・条件は会場ごとに異なるため
「確定のご連絡でご案内」と表示し、金額は画面に出しません。

| 旅行先 | ホテル | チャペル |
|---|---|---|
| ハワイ | ハレクラニ、ザ・カハラ・ホテル＆リゾート | キャルバリー・バイ・ザ・シー教会 |
| 沖縄本島（新規） | — | ラソール ガーデン・アリビラ、ラソール シーリゾート、ザ・サーフ ビーチサイドテラス、アートグレイス沖縄、サザンチャペル |
| モルディブ | フォーシーズンズ ランダーギラーヴァル、ギリ ランカンフシ | フォーシーズンズ ランダーギラーヴァルのチャペル |

沖縄のチャペルは宮古島ではなく沖縄本島にあるため、旅行先「沖縄本島（OKINAWA）」を追加しました（写真は未提供）。
...
2. **Destinations**（主役）— 「旅行先から、プロポーズを探す。」写真カード（名前・From 価格・プランを見る →）。
   スマホ2列・PC4列（11件で4・4・3）。横スクロールなし。下に「まだ旅行先が決まっていない方へ」
...
5. **Venue** — 「ホテルでも、チャペルでも。」会場のある旅行先の一覧
...
- 10か所はご提供の写真を使用しています（ハワイは透かしなしの差し替え版）。沖縄本島は写真未提供のため、イラストの仮表示です。

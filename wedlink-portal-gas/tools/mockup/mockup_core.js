...
(function () {
  ...
  // ★要件（項目101⑥）：案件一覧を方面でまとめて絞り込むデモ。実運用では支店マスタの
  // 「方面」列（マスタ管理画面からも入力できる）に、支店ごとに方面を書いて使う。
  [['ROW', 'ヨーロッパ'], ['VIE', 'ヨーロッパ'], ['AMS', 'ヨーロッパ'], ['GVA', 'ヨーロッパ'],
   ['ATH', 'ヨーロッパ'], ['LON', 'ヨーロッパ'], ['FRA', 'ヨーロッパ'],
   ['IST', '中東・アフリカ'], ['DXB', '中東・アフリカ'], ['CAI', '中東・アフリカ'],
   ['CAS', '中東・アフリカ'], ['NBO', '中東・アフリカ'], ['JED', '中東・アフリカ'],
   ['CUN', '北中米'], ['YVR', '北中米'], ['LPB', '南米'],
   ['FIJ', 'オセアニア'], ['AUS', 'オセアニア'], ['NZL', 'オセアニア'],
   ['DPS', 'アジア'], ['TPE', 'アジア'], ['SIN', 'アジア'], ['REP', 'アジア'], ['TAS', 'アジア']]
    .forEach(([code, region]) => setBmByCode(code, '方面', region));
